...
from .models import Order, OrderItem, Review, Coupon
...
class OrderAdmin(admin.ModelAdmin):
    list_display = ['id', 'user', 'full_name', 'total_amount', 'discount_amount', 'coupon_code', 'status', 'created_at', 'has_tracking']
    ...
    fieldsets = [
        ('Order Information', {
            'fields': [
                ...
                'total_amount', 'shipping_cost', 'tax_amount', 'discount_amount', 'coupon_code'
            ]
        }),
...
class CouponAdmin(admin.ModelAdmin):
    list_display = ['code', 'amount', 'is_active', 'valid_from', 'valid_to', 'created_at']
